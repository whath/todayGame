...
SaveSnapshot schema 3 保存 profileId、slotId、savedAt、ProfileSnapshot 和可空 SessionSnapshot。Profile 记录已解锁内容、已完成关卡、会话数；Session 记录关卡 / 角色 ID、seed / randomState、经过秒数和两位玩家坐标。仅序列化 DTO；不保存 Node、Component、设备身份和输入帧。
